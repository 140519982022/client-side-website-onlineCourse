              ...
              <div className="row my-5">
                <form action="" className=''>
                  <div className="form-place">
                    ...
                    <input type="text" className='border border-4 w-100 bg-transparent border-wgite border-top-0 border-start-0 border-end-0 placeholder py-3' placeholder='Your Name' />
                  </div>
                  <div className="form-place">

                    <input type="email" className='border border-4 w-100 bg-transparent border-wgite border-top-0 border-start-0 border-end-0 placeholder py-3' placeholder='Your Email' />
                  </div>
