          ...
          <div className="row py-5">
            <div className="col-md-12">
              ...
              <div className='text-center py-2'>
                ...
                <div className="container">
                  <div className="row">
                  <div className="col-md-3 myBox p-1">
                      <div className='card-style '>
                        <div className="innerDiv ">
                          <Button variant="warning " className='mt-3 ms-3 position-absolute top-0 start-0'>Warning</Button>
                          <p className='text-white fw-bold position-absolute top-50 start-50 translate-middle'>
                            Preview Course
                          </p>
                        </div>
                          <Card className=''>
